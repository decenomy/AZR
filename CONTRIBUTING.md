Contributing to AEZORA Core
============================

The AEZORA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Aezora/aezora/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AEZORA Core project, and is not to be
confused with overall AEZORA Network Protocol consensus changes.

Whether a pull request is merged into AEZORA Core rests with the project merge
...
Patches that change AEZORA consensus rules are considerably more involved than
...
Where a patchset proposes to change the AEZORA consensus, it must have been
...
The project leader is the release manager for each AEZORA Core release.
