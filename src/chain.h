...
static const int DBI_SER_VERSION_NO_MS = 1009902;   // removes nMoneySupply from persisted block index
// New serialization introduced on DSW
static const int DBI_SER_VERSION_MS = 2030000;   // reintroduces the nMoneySupply to the persisted block index
