...
#ifndef AEZORA_ZAZRTRACKER_H
#define AEZORA_ZAZRTRACKER_H
...
public:
    CzAZRTracker(std::string strWalletFile);
    ~CzAZRTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAZRWallet* zAZRWallet = NULL);
