// Copyright (c) 2017-2018 The AEZORA developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef AEZORA_ZAZRWALLET_H
#define AEZORA_ZAZRWALLET_H
...
public:
    CzAZRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAZR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAZR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
