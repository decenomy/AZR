...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AZR);
    unitlist.append(mAZR);
    unitlist.append(uAZR);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case AZR:
        return QString("aezora");
    case mAZR:
        return QString("maezora");
    case uAZR:
        return QString::fromUtf8("uaezora");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAZR)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZAZR);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAZR)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZAZR));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
