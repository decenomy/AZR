...
AEZORAGUI::AEZORAGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void AEZORAGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &AEZORAGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &AEZORAGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &AEZORAGUI::showHide);
    ...
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &AEZORAGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &AEZORAGUI::execDialog);
}
...
#ifndef Q_OS_MAC
void AEZORAGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void AEZORAGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
bool AEZORAGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
    ...
    if (isVisible()) {
        ...
        dialog->setWindowTitle(tr("AEZORA Core"));
        dialog->adjustSize();
        dialog->raise();
        dialog->exec();
    }
...
bool AEZORAGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    connect(addressesWidget, &AddressesWidget::message,this, &AEZORAGUI::message);
...
static bool ThreadSafeMessageBox(AEZORAGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void AEZORAGUI::subscribeToCoreSignals()
{
    // Connect signals to client
    uiInterface.ThreadSafeMessageBox.connect(boost::bind(ThreadSafeMessageBox, this, _1, _2, _3));
}

void AEZORAGUI::unsubscribeFromCoreSignals()
{
