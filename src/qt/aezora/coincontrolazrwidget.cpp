...
#include "qt/aezora/coincontrolazrwidget.h"
#include "qt/aezora/forms/ui_coincontrolazrwidget.h"

CoinControlAzrWidget::CoinControlAzrWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlAzrWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select AZR Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("AZR");
    ...
    ui->labelValueAfter->setText("0.00 AZR");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 AZR");
    ui->labelValueFee->setText("0.00 AZR");
...
CoinControlAzrWidget::~CoinControlAzrWidget()
{
    delete ui;
}
