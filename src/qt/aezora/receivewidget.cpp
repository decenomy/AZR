...
#include "qt/aezora/forms/ui_receivewidget.h"
...
#include "qt/aezora/addressholder.h"
...
ReceiveWidget::ReceiveWidget(AEZORAGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive AZR."));
