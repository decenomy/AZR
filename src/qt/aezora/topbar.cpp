...
#include "qt/aezora/forms/ui_topbar.h"
#include "qt/aezora/lockunlock.h"
#include "qt/aezora/qtutils.h"
#include "qt/aezora/receivedialog.h"
...
TopBar::TopBar(AEZORAGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountAzr, ui->labelAvailablezAzr}, "amount-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("AEZORA")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // Set
    QString totalAzr = GUIUtil::formatBalance(azrAvailableBalance, nDisplayUnit);
