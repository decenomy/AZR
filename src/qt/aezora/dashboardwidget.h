...
#include "config/aezora-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalAzr = 0;
    qint64 totalZazr = 0;
    QList<qreal> valuesAzr;
    QList<qreal> valueszAzr;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(AEZORAGUI* _window);
    ~DashboardWidget();
