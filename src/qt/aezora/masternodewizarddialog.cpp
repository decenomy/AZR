...
#include "qt/aezora/forms/ui_masternodewizarddialog.h"
...
bool MasterNodeWizardDialog::createMN()
{
    if (walletModel) {
        ...
        SendCoinsRecipient sendCoinsRecipient(
                ...
                CAmount(GetMasterNodeCollateral(chainActive.Height())) * COIN,
                "");
