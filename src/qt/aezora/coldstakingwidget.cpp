...
#include "qt/aezora/coldstakingwidget.h"
#include "qt/aezora/forms/ui_coldstakingwidget.h"
#include "qt/aezora/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/aezora/requestdialog.h"
#include "qt/aezora/tooltipmenu.h"
#include "qt/aezora/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(AEZORAGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your AZRs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept AZR delegation / Delegate AZR"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select AZR outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 AZR" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
