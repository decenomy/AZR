...
#include "qt/aezora/forms/ui_masternodeswidget.h"

#include "qt/aezora/qtutils.h"
#include "qt/aezora/mnrow.h"
#include "qt/aezora/mninfodialog.h"
#include "qt/aezora/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(AEZORAGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:14725 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
