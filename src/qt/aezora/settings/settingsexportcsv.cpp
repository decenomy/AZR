...
// Copyright (c) 2019-2020 The AEZORA developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/aezora/settings/settingsexportcsv.h"
#include "qt/aezora/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(AEZORAGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("AEZORA_tx_csv_export(*.csv)") : tr("AEZORA_addresses_csv_export(*.csv)"),
                                        nullptr);
