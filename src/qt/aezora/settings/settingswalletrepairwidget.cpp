...
#include "qt/aezora/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/aezora/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(AEZORAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to AEZORAGUI::handleRestart()
