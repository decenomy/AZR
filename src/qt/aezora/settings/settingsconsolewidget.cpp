...
#include "qt/aezora/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/aezora/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(AEZORAGUI* _window, QWidget *parent) :
