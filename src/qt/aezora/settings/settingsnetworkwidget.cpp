...
#include "qt/aezora/settings/settingsnetworkwidget.h"
#include "qt/aezora/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/aezora/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(AEZORAGUI* _window, QWidget *parent) :
