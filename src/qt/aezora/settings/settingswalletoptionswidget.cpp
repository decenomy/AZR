...
#include "qt/aezora/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/aezora/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(AEZORAGUI* _window, QWidget *parent) :
