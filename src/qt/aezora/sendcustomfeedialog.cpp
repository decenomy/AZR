...
#include "qt/aezora/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(AEZORAGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &AEZORAGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
