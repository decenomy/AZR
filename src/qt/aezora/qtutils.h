...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, AEZORAGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, AEZORAGUI* gui, double posX = 3);
