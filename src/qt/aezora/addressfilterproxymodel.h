...
#ifndef AEZORA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define AEZORA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //AEZORA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
