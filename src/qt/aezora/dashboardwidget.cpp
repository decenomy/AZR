    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of AZR staked."));
    ...
    ui->labelAmountZazr->setText("0 zAZR");
    ui->labelAmountZazr->setVisible(false);
    ui->labelAmountAzr->setText("0 AZR");
    ...
    ui->btnHowTo->setText(tr("How to get AZR"));
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("AZR");
    set1 = new QBarSet("zAZR");
