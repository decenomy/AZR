    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of AZR earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 AZR");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair AZR
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(230,193,218));
	set1->setColor(QColor(149,217,253));
