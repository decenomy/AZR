...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 14725;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // AEZORA starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nAezoraBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nAezoraBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1576918337;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2012178;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c76e5393b390e03a0c0ecd6e773a99bb906d30aa8bc2a1108146bc78561"));
        ...
        strSporkPubKey = "04E9BC0227525E3C398B36566DB2361D09B1B63554B12D31BCD547CDAE74D9DCED042740772B7E2A81EDF4EB1CA709666DB0DA3093732E21A0F0D9E43B2C75D08D";
        strSporkPubKeyOld = "0447DAA62E208D6BF276F8FF192CBDAD9759461481284D3C43C0ED442A60607AB75C9820891FCDDE9A95B856B0F6F6BD1F05F814C63D219F4ECF9F18F70B8D0543";
        strObfuscationPoolDummyAddress = "AMwfSyGduanRV4y369S6MYAn9GoFZAWdY4";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zazr to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nAezoraBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nAezoraBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        strSporkPubKeyOld = "043BA0B3D539A3F8AD1318F2641B3680935D37AFAE256A25083AB6D50495FD28C1F35EE4DCDD79D1CCED5F7DCBF1989566E4256689429B15CED9660442C0B45FAD";
