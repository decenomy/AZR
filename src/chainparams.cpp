...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (250907, uint256S("1f9f524d819ddbf0c9ca7cbdc6d453c63686fae48888da0f609d82687792c18e"))
    (501815, uint256S("2b8c5b68e5dd4a6d0a79da662fa5b15431b40785d923280906cc1e270cd2301e"))
    (752723, uint256S("13a091fdbe6d0431f44b50c320205acae4a77d47d13a5b5f62d622a6c024180b"))
    (1003631, uint256S("ce50bea43a5df457a313881e5c9fad70bc863d9ce281c9729774136787dbb3e2"))
    (1254539, uint256S("79dfadf9d9404a727b27ef50b4cc1cab92eb99f786b20a8fd969d31efd57ec98"))
    (1505447, uint256S("a646c8df28e2e29e6a2132ecb152575b667065b53073d0470efd04c15339d434"))
    (1756355, uint256S("6a3efb5c2bcc08071906716736a9bdfd7ec64cd701e12f220ba1613e882d2658"))
    (2007263, uint256S("ce180d144c20f6362e20fab90e1b1bea0f2a8951051e91bf4edf8e228813bb12"))
    (2258171, uint256S("4a3ea98b155a29b7bd990b1e42063fb90fe181ed7745a32415fc6944f720fa7b"))
;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1717172745, // * UNIX timestamp of last checkpoint block
    5209439,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_DYNAMIC_REWARDS].nActivationHeight           = 2600001;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS_V3].nActivationHeight                    = 2600001;
