...
The build script we'll be using is contained in the AEZORA github repository ([contrib/gitian-build.py](https://github.com/Aezora/aezora/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the AEZORA repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Aezora/AEZORA/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, aezora-detached-sigs, and aezora GitHub repos.
