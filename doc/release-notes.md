...
Automatic zAZR backup has been disabled. Thus, the following configuration options have been removed  (either as entries in the aezora.conf file or as startup flags):
- `autozazrbackup`
- `backupzazr`
- `zazrbackuppath`
...
The default value for the stake-split threshold has been lowered from 2000 AZR, down  to 500 AZR.


Dependencies
------------

The minimum required version of QT has been increased from 5.0 to 5.5.1 (the [depends system](https://github.com/aezora-project/aezora/blob/master/depends/README.md) provides 5.9.7)
