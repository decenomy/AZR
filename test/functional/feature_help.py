...
"""Verify that starting aezora with -h works as expected."""
import subprocess

from test_framework.test_framework import AezoraTestFramwork
from test_framework.util import assert_equal

class HelpTest(AezoraTestFramwork):
    ...
    def run_test(self):
        self.log.info("Start aezora with -h for help text")
        ...
        self.log.info("Start aezora with -version for version information")
