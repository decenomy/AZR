...
class RawTransactionsTest(AezoraTestFramwork):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid aezora address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid aezora address" in e.error['message'])
